...
Vista de presidentes ampliada a toda la web: identidad efectiva, escudo y permisos visibles permanecen al navegar, con Mi cuenta y Mi equipo propios. Barra global para cambiar de usuario o regresar a administración; sin cambiar sesiones ni permitir escrituras. Se conserva el paso real de contraseña temporal y existe una simulación explícita del panel posterior. Validación actual: 84 pruebas y compilación correctas, navegación pública/privada y móvil revisados.
