...
```text
.
├─ public/                       # Escudos, logos, tira de patrocinadores y tarjeta social
├─ src/
│  ├─ app/                       # Router hash
...
Los escudos optimizados, los logotipos, la tipografía incluida y la tira pública de patrocinadores del footer son los activos históricos necesarios para el frontend; no hace falta publicar los originales de producción.
