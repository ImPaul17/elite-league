...
- La ficha privada reutiliza el escudo, histórico, información y palmarés de la ficha pública. Incluye Mi plantilla, selector de alineación por jornada, calendario/resultados y clasificación. Retirado el bloque «Próximo partido»; Mi plantilla ocupa el ancho disponible, sin dejar una columna vacía. Los jugadores y el envío de alineaciones siguen deshabilitados hasta su incorporación.
...
- La vista administrativa abre directamente Mi equipo, aunque el presidente tenga pendiente cambiar su contraseña temporal. No muestra el aviso ni necesita un paso de inicio de sesión o una casilla para continuar. Mi cuenta muestra el usuario en solo lectura, sin ese aviso. Esto solo afecta a la proyección: el propietario sigue obligado a cambiar su temporal al entrar con su sesión real y su cuenta no se modifica. La selección vive en memoria de la pestaña; se descarta al recargar, salir, cambiar de sesión o perder permisos de administración.
...
Ajuste posterior solicitado: la vista administrativa entra directamente al panel, sin aviso de contraseña temporal ni casilla intermedia. 85 pruebas y compilación correctas. Comprobado con Coca y Bea, también al cambiar de presidente y abrir Mi cuenta; los campos de contraseña permanecen deshabilitados en la vista. La prueba de regresión verifica que el acceso real del propietario temporal sigue bloqueado hasta cambiar su contraseña y que su cuenta no se modifica.
